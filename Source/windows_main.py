...
class showDisplay(Frame):
    def __init__(self, master):
        ...
        self.episodeRange = Text(self.episodesSelectFrame, width=15, height=1,font=("Arial", 10))
        self.episodeRange.insert(INSERT, "Non-Functional")
...
if __name__ == "__main__":
    ...
    photo = PhotoImage(file=resource_path("favicon.png"))
